    ...
    def replan_node(state: State, config):
        ...
        if model_type=="clause":
            human = (
                ...
                # "계획에 이제 해야 단계들을 추가하고, 이전에 완료한 계획은 포함하지 마세요."
                # "새로운 계획에는 <plan> tag를 붙여주세요."
                # "만약 더 이상 계획을 세우지 않아도 주어진 질문에 답변할 수 있다면, 최종 답변에 <result> tag를 붙여 전달합니다."

                "당신은 <original_plan> tag의 원래 계획을 상황에 맞게 수정하세요."
                "<paragraph> tag의 주어진 문장과 <question> tag의 주어진 질문을 참조하여 <list_choices> tag의 선택지에서 거장 적절한 항목을 선택하기 위해서는 잘 세워진 계획이 있어야 합니다."
                #"당신의 원래 계획과 완료한 계획을 참조하여 다음에 해야할 계획을 step by step 방식으로 세웁니다."
                "수정된 계획에 아직 수행되지 않은 계획들을 포함하세요."
                "수정된 계획에 <past_steps> tag의 완료한 단계는 포함하지 마세요."
                "새로운 계획에는 <plan> tag를 붙여주세요."
                "만약 더 이상 계획을 세우지 않아도 주어진 질문에 답변할 수 있다면, 최종 답변에 <result> tag를 붙여 전달합니다."
            ...
            human = (
                ...
                "당신의 원래 계획에서 아직 수행되지 않은 계획들을 수정된 계획에 포함하세요."
                "수정된 계획에 완료한 단계는 포함하지 마세요."
