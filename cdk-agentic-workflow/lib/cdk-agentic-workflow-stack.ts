...
EOF'`,
      ...
      `runuser -l ec2-user -c 'pip install boto3 langchain_aws langchain langchain_community langgraph opensearch-py langchain_experimental'`,
      `runuser -l ec2-user -c 'pip install PyPDF2 yfinance rizaio plotly_express numpy matplotlib'`,
